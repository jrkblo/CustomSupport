...
class Collection implements ArrayAccess, Countable
{
     ...
     *
     * @param  \Acconplish\Support\Collection  $collection
     * @param  string  $type
     * @return $this
     */
    public function attach(Collection $collection, $type = 'Acconplish\Support\Collection')
    {
